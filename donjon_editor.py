...
def editeur_donjon(donjon, chemin_edit, play_obj=None):
    ...
    while True:
        ...
        if ty == "Quitte":
            ...
            if f.touche(ev) == "a" and valid_map(donjon):
                ...
                x, y = case_vers_pixel((i, j), 600, 600)
                senzu = (i, j)
                f.image(x, y, "Media/background_images/senzu.gif", largeur = 300, hauteur= 300, ancrage="center", tag="senzu")
                ...
                f.image(
                    x,
                    y,
                    "Media/background_images/nuage.gif",
                    hauteur=60,
                    largeur=60,
                    ancrage="center",
                    tag="nuage",
